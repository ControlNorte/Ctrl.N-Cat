...
from .teste import download_modelo_importacao_cadastro_subcategoria, download_modelo_importacao_cadastro_centrodecusto, download_modelo_importacao_cadastro_regras, aplicar_regras_em_transicoes
...
urlpatterns = [
    ...
    path('aplicar-regras/<str:banco>/<str:cliente>/<str:tenant>/', aplicar_regras_em_transicoes, name='aplicar_regras')
]
